...
| `brainstorming/docs/adr/ADR-0003-keep-plugin-skill-mirrors-copied.md` | Plugin mirror ownership ADR |
| `brainstorming/docs/adr/ADR-0004-defer-official-binary-and-package-manager-install-paths.md` | Runtime install path deferral ADR |
| `docs/adr/ADR-0002-plan-installed-runtime-boundary.md` | Root copy of runtime extraction boundary ADR |
| `docs/adr/ADR-0003-keep-plugin-skill-mirrors-copied.md` | Root copy of plugin mirror ownership ADR |
| `docs/adr/ADR-0004-defer-official-binary-and-package-manager-install-paths.md` | Root copy of runtime install path deferral ADR |
...
| `scripts/python/template_cli/bootstrap_update_apply.py` | Project harness update apply execution, backup, rollback, hook, and validation helpers |
...
| `scripts/python/template_cli/intent_registry.py` | Intent registry loading, schema validation, and command lookup helpers |
| `scripts/python/template_cli/intents.py` | Intent registry rendering and compatibility exports for generated intent-doc sync helpers |
...
| `scripts/python/template_cli/workflow_export.py` | Lab idea summary export command handler |
| `scripts/python/template_cli/workflow_idea_commands.py` | Idea lifecycle command handlers for capture, activation, parking, and killing |
