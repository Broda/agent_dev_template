...
- Notes live under `.harness/history/notes/` and are indexed in `.harness/history/NOTES_CATALOG.md`.
- Search `.harness/history/NOTES_CATALOG.md` before opening note files.
...
Brainstorming-only commands are intentionally blocked in development mode by `.harness/commands/intent_registry.json`.
