...
WORKFLOW_MODULES = [
    ".harness/runtime/python/template_cli/workflow.py",
    ".harness/runtime/python/template_cli/workflow_catalog.py",
    ".harness/runtime/python/template_cli/workflow_commands.py",
    ".harness/runtime/python/template_cli/workflow_data.py",
    ".harness/runtime/python/template_cli/workflow_development_status.py",
    ".harness/runtime/python/template_cli/workflow_export.py",
    ".harness/runtime/python/template_cli/workflow_idea_commands.py",
    ".harness/runtime/python/template_cli/workflow_readiness.py",
