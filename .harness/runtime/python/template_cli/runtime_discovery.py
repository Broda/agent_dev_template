...
READ_ONLY_FALLBACK_WARNING = "harness-runtime warning: installed runtime is incompatible; using repo-local fallback at .harness/runtime/python/cli.py"
...
def _source_checkout_resolution(source_root: Path, backend_command: str) -> RuntimeResolution:
    cli_path = source_root / ".harness/runtime/python/cli.py"
