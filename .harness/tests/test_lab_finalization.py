...
class LabFinalizationTests(LabWorkflowTestCase):
    def test_lab_finalize_wrapper_records_session_and_switches_mode(self) -> None:
        ...
        self.assertFalse((self.repo / "ideas").exists())
        self.assertFalse((self.repo / "sessions").exists())
        sessions = sorted((self.repo / ".harness/history/sessions").glob("*FINALIZATION_SESSION*.md"))
        self.assertTrue(sessions)
        exports = sorted((self.repo / ".harness/history/exports").glob("*PROJECT_SUMMARY*.md"))
    ...
    def test_lab_finalize_preserves_curated_artifact_references(self) -> None:
        ...
        self.assertEqual(
            ...
            ".harness/history/notes/2026-04-03_note-0001-preserved-reference.md",
        )
        self.assertEqual(
            artifacts["summaryExport"],
            ".harness/history/exports/2026-04-03_PROJECT_SUMMARY_idea-finalize-preserve.md",
        )
