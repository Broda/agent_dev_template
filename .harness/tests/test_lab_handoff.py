...
class LabHandoffTests(LabWorkflowTestCase):
    ...
    def test_lab_handoff_to_noninteractive_finalize_golden_flow(self) -> None:
        ...
        self.assertIn(
            ".harness/history/sessions/2026-04-04_idea-lossless-handoff.md", state["artifacts"]["sessionFiles"]
        )

        catalog = (self.repo / ".harness/history/IDEA_CATALOG.md").read_text(encoding="utf-8")
