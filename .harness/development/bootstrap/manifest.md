# .harness/development/bootstrap/manifest.md — Structured Mode Bootstrap
...
- Render governance docs from `.harness/development/templates/` after successful initialization
...
Note: CHANGELOG.md must be generated from `.harness/development/templates/docs/CHANGELOG.base.md`.
...
### .gitignore
Select the best baseline from `.harness/development/templates/gitignore/`:
...
- Keep template assets under `.harness/development/templates/` and `.harness/development/bootstrap/` for template maintenance only.
