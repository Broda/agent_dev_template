...
- `.harness/plugins/project-lifecycle-lab/skills/` contains copied mirrors for distribution.
...
Portable plugin skills under `.harness/plugins/project-lifecycle-lab/skills/` are
...
To smoke-check the package outside the repo context, install or expose `.harness/plugins/project-lifecycle-lab` as a local Codex plugin and confirm the four skills are visible:
