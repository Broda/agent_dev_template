...
`plugins/project-lifecycle-lab/` exposes copied skill mirrors for portable
...
- Affected files: `plugins/project-lifecycle-lab/README.md`,
  `scripts/python/template_cli/validator_plugins.py`,
  `HARNESS_IMPROVEMENT_ROADMAP.md`, `brainstorming/FILE_MAP.md`.
