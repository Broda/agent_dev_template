...
Read:
- .harness/development/bootstrap/manifest.md

Review:
- .harness/development/templates/docs/*.base.md
- .harness/development/templates/docs/adr/*
- .harness/development/templates/gitignore/*.gitignore
...
- Keep `.harness/development/templates/` and `.harness/development/bootstrap/` as maintenance assets for the template itself, not as day-to-day governance.
