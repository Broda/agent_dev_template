...
class IntentRegistryContractTests(LabWorkflowTestCase):
    def test_render_intent_docs_is_idempotent_on_clean_repo(self) -> None:
        ...
        first_commands = (self.repo / ".harness/commands/COMMANDS.md").read_text(encoding="utf-8")
        run_cmd(["./scripts/render-intent-docs"], cwd=self.repo)
        second_conv = (self.repo / ".harness/commands/CONVERSATIONAL_MODE.md").read_text(encoding="utf-8")
        second_commands = (self.repo / ".harness/commands/COMMANDS.md").read_text(encoding="utf-8")
    ...
    def test_validate_governance_fails_on_stale_generated_intent_section(self) -> None:
        conv_path = self.repo / ".harness/commands/CONVERSATIONAL_MODE.md"
    ...
    def test_validate_governance_fails_on_unknown_registry_command(self) -> None:
        registry_path = self.repo / ".harness/commands/intent_registry.json"
    ...
    def test_validate_governance_checks_non_lab_wrapper_backend_exposure(self) -> None:
        cli_path = self.repo / ".harness/runtime/python/cli.py"
    ...
    def test_validate_governance_checks_lab_cli_parser_dispatch_table_parity(self) -> None:
        dispatch_path = self.repo / ".harness/runtime/python/template_cli/lab_cli_dispatch.py"
    ...
    def test_render_intent_docs_applies_registry_schema(self) -> None:
        schema_path = self.repo / ".harness/commands/intent_registry.schema.json"
    ...
    def test_generated_docs_include_capability_surface(self) -> None:
        commands = (self.repo / ".harness/commands/COMMANDS.md").read_text(encoding="utf-8")
        conversational = (self.repo / ".harness/commands/CONVERSATIONAL_MODE.md").read_text(encoding="utf-8")
    ...
    def test_render_intent_docs_fails_on_missing_markers(self) -> None:
        commands_path = self.repo / ".harness/commands/COMMANDS.md"
